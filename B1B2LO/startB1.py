...
class Window(QMainWindow, form_class):
    ...
    def btn_refresh_clicked(self):
        ...
        for i in range(0, 48):
          ...
          if(i%2):
            field="B%d_MultI_%d" % (isB2+1,int((i+2)/2))
          else:
            field="B%d_MultV_%d" % (isB2+1,int((i+2)/2))
          self.multLayout.itemAt(i).widget().setText(str(getattr(v, field)))

        for i in range(0, 24):
          field="B%d_DAC_%d" % (isB2+1,i+1)
        ...
        self.textEdit_25.setText(str(v.B1_PSatV_1))
        self.textEdit_26.setText(str(v.B1_PSatV_2))
        self.textEdit_27.setText(str(v.B1_PSatV_3))
        self.textEdit_28.setText(str(v.B1_PSatV_4))
        self.textEdit_29.setText(str(v.B1_PSatV_5))
        self.textEdit_30.setText(str(v.B1_PSatV_6))
        self.textEdit_31.setText(str(v.B1_PSatV_7))
        self.textEdit_32.setText(str(v.B1_PSatV_8))

        self.spin_psat_dac_1.blockSignals(True)
        self.spin_psat_dac_1.setValue(int(v.B1_PSatDac_1))
        self.spin_psat_dac_1.blockSignals(False)
        self.spin_psat_dac_2.blockSignals(True)
        self.spin_psat_dac_2.setValue(int(v.B1_PSatDac_2))
        self.spin_psat_dac_2.blockSignals(False)
        self.spin_psat_dac_3.blockSignals(True)
        self.spin_psat_dac_3.setValue(int(v.B1_PSatDac_3))
        self.spin_psat_dac_3.blockSignals(False)
        self.spin_psat_dac_4.blockSignals(True)
        self.spin_psat_dac_4.setValue(int(v.B1_PSatDac_4))
        self.spin_psat_dac_4.blockSignals(False)
        self.spin_psat_dac_5.blockSignals(True)
        self.spin_psat_dac_5.setValue(int(v.B1_PSatDac_5))
        self.spin_psat_dac_5.blockSignals(False)
        self.spin_psat_dac_6.blockSignals(True)
        self.spin_psat_dac_6.setValue(int(v.B1_PSatDac_6))
        self.spin_psat_dac_6.blockSignals(False)
        self.spin_psat_dac_7.blockSignals(True)
        self.spin_psat_dac_7.setValue(int(v.B1_PSatDac_7))
        self.spin_psat_dac_7.blockSignals(False)
        self.spin_psat_dac_8.blockSignals(True)
        self.spin_psat_dac_8.setValue(int(v.B1_PSatDac_8))
        self.spin_psat_dac_8.blockSignals(False)

        self.textEdit_19d_1.setText(str(v.B1_GMONI_1))
        self.textEdit_19d_2.setText(str(v.B1_GMONI_2))
        self.textEdit_19d_3.setText(str(v.B1_GMONI_3))
        self.textEdit_19d_4.setText(str(v.B1_GMONI_4))
        self.textEdit_19d_5.setText(str(v.B1_GMONI_5))
        self.textEdit_19d_6.setText(str(v.B1_GMONI_6))
        self.textEdit_19d_7.setText(str(v.B1_GMONI_7))
        self.textEdit_19d_8.setText(str(v.B1_GMONI_8))
        self.textEdit_19d_V.setText(str(v.B1_GMONV))
    ...
    def btn_open_clicked(self):
        ...
        Ser = serial.Serial(
            #port='/dev/ttyACM0',
            port='/dev/cu.usbmodemB1LO_CTRL1',
            baudrate=115200,
            timeout=1
        )
        cmd="id\r"
